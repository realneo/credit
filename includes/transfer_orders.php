  ...
  <tr>
   ...
   <?php 
    ...
    <tr>
        ...
        <td class='order_transfer_btn no-print'><i class='fa fa-check text-desaturated-blue'></i> <a href='' class='text-desaturated-blue'>Transfered</a></td>
    </tr>
    <?php } ?>
</table>